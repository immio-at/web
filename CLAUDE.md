...
- **Filter pill-bar layout (Session 53 follow-up, already shipped).** The four range sliders sit on one line below the TOM ("listed within") row; the postcode entry moved up next to the Bundesland state pills. See `PresetFilters.tsx`.
