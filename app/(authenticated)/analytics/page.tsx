  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <p className="text-[11px] font-mono uppercase tracking-widest text-teal-600 mb-3">Analytics</p>
        ...
        <p className="text-sm text-gray-400 font-light leading-relaxed mb-8">
          Das Analytics-Dashboard ist in Entwicklung. Hier findest du bald Markttrends,
          Preisverläufe und Auswertungen deines Portfolios.
        </p>
