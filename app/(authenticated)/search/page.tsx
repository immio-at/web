...
import { getScrapedListings, saveScrapedListing, importFromUrl, ScrapedListing, SavedFilter } from '@/lib/api';
...
export default function EntdeckenPage() {
  ...
  async function handleImportUrl(e: React.FormEvent) {
    ...
    try {
      ...
      setImportSuccess(`"${result.property.title || 'Inserat'}" wurde zu deinen Immobilien hinzugefügt.`);
      setImportUrl('');
      invalidateCache();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      {/* URL Import */}
      <form onSubmit={handleImportUrl} className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
